...
The simplified architecture of the Argent Wallet Smart Contract is shown in attachment \addattachment{A1-ArgentWalletsOriginal.png}{\textit{A1-ArgentWalletsOriginal}}, where the main components are: \cite{argent-smart-wallet-specifications}
