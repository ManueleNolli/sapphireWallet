...
The simplified architecture of the Argent Wallet Smart Contract is shown in attachment \addattachment{ArgentWalletsBlockchainSmartContract.png}{ArgentWalletsBlockchainSmartContract}, where the main components are: \cite{argent-smart-wallet-specifications}
