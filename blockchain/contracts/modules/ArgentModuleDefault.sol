...
/**
 * @title ArgentModuleDefault
 * @notice Single module for the Argent wallet.
 * @author Julien Niset - <julien@argent.xyz>
 */
contract ArgentModuleDefault is BaseModule, RelayerManager, SecurityManager, TransactionManager {

    bytes32 constant public NAME = "ArgentModuleDefault";
    ...
    */
    ...
    function getRequiredSignatures(address _wallet, bytes calldata _data) public view override returns (uint256, OwnerSignature) {
        ...
        if (methodId == TransactionManager.multiCall.selector ||
            ...
            methodId == ArgentModuleDefault.addModule.selector ||
