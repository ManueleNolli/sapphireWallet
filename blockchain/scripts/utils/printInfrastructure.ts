...
export default async function printInfrastructure(infrastructure: InfrastructureAddresses | Infrastructure) {

    let infrastructureAddresses: InfrastructureAddresses;

    if ((infrastructure as Infrastructure).baseWallet) { // infrastructure is type Infrastructure
        ...
        infrastructureAddresses = {
            ...
            uniswapFactoryAddress: await infrastructure.uniswapFactoryMock.getAddress(),
