...
import { ethers, Wallet, ContractTransaction, ZeroAddress } from 'ethers';
...
describe('WalletFactoryService', () => {
  ...
  describe('callWalletFactoryContract', () => {
    it('should create a counterfactual wallet and return the expected address - Guardian is not ZeroAddress', async () => {
      ...
      const data: CreateWalletRequest = {
        ...
        guardianAddress: 'mockedGuardianAddress',
    ...
    it('should create a counterfactual wallet and return the expected address - Guardian is ZeroAddress', async () => {
      // Mocking environmentService.getContractAddress method
      const getWithNetworkMock = jest.spyOn(
        // for argentModuleAddress
        environmentService,
